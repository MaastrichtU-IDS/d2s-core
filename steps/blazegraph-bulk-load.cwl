...
# URL of dataloader.txt to use (will be downloaded at runtime)
"https://raw.githubusercontent.com/MaastrichtU-IDS/d2s-scripts-repository/master/resources/blazegraph/dataloader.txt"]
